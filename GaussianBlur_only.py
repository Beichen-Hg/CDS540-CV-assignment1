...
detected_text = pytesseract.image_to_string(blur_image)
end_time = time.time()
...
h, w, _ = image.shape
boxes = pytesseract.image_to_boxes(blur_image, config=custom_config)
...
#Step 8: Accuracy Evaluation (example with known ground truth)
ground_truth_text = """
Introduction
